...
class User(db.Model):
    ...
    access_token = db.Column(db.String(80), index=False, nullable=False)
    created = db.Column(db.DateTime, nullable=False, default=lambda: datetime.datetime.now())
...
class Event(db.Model):
    ...
    event_name = db.Column(db.String(80), index=True, unique=False, nullable=False)
    book_id = db.Column(db.String(80), index=True, unique=False, nullable=False)
